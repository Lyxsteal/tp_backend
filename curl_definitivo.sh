...
curl "http://localhost:8081/api/v1/solicitudes/contenedores/estado/10"
...
curl "http://localhost:8085/api/v1/rutas/camiones/XYZ789"
echo ""
...
curl "http://localhost:8085/api/v1/rutas/camioneros/201"
echo ""
...
curl -X POST -H "Content-Type: application/json" -d '{"direccion": "Punto de Carga A", "latitud": -34.60, "longitud": -58.45}' "http://localhost:8085/api/v1/rutas/ubicaciones"
