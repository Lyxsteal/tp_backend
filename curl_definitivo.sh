...
curl -X PUT -H "Content-Type: application/json" -d '5' "http://localhost:8081/api/v1/solicitudes/asignar-ruta/1"
echo ""
...
echo "CREAR TARIFA"
curl -X POST -H "Content-Type: application/json" -d '{"valorFijoTramo": 100.0, "valorPorVolumen": 5.5, "valorFijoCombustible": 50.0}' "http://localhost:8081/api/v1/solicitudes/tarifas"
echo "ACTUALIZAR TARIFA"
curl -X PUT -H "Content-Type: application/json" -d '{"idTarifa": 1, "valorFijoTramo": 110.0, "valorPorVolumen": 6.0, "valorFijoCombustible": 55.0}' "http://localhost:8081/api/v1/solicitudes/tarifas/1"
